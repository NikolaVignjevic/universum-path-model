...
# ---------------- Parameters ----------------
gal_name = "NGC2403"
csv_path = os.path.join("data", "sparc_ngc2403.csv")  # <- deine SPARC-CSV

# Gitter
nx = ny = 512
dx_kpc = 0.4  # NGC 2403 ist kompakter; kleineres dx gibt mehr Innenauflösung

# Spur-Parameter (du kannst sie 1:1 von 3198 übernehmen)
ell_kpc = 4.0
tau_gyr = 5.0
D_kpc2_per_gyr = 0.25
Gamma_W = 1.0
